...
$champs=array('id_etablissement','date_in','date_modif','nom','adresse','code_postal','id_ville',
	'id_pays','id_type_etablissement','gestion','www','id_photo');
$filtres=array('id_etablissement' => $id);
$infos=recuperation_donnees(generation_requete($table,$champs,$filtres,$ordre));

$html.='<table>
			<tr>
				<th>id_etablissement </th><td>'.$infos[0]['id_etablissement'].'</td>
			...
			<tr>
				<th>Type établissement</th><td colspan="5">'.generation_select('id_type_etablissement','a_type_etablissement',array('id_type_etablissement','libelle'),$infos[0]['id_type_etablissement']).'</td>
			</tr>
			<tr>
