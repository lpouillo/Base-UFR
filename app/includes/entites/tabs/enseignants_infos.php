...
if ($mode=='rw' AND $_POST['page']!='mon_espace') {
	$champs=array('id_enseignant','date_in','date_modif','id_civilite','uid','nom','prenom','epouse','id_photo',
		'id_laboratoire','id_etablissement','id_statut','id_ufr','id_grade',
		'CNU','adresse_pro','code_postal_pro','id_ville_pro','id_pays_pro',
		'adresse_perso','code_postal_perso','id_ville_perso','id_pays_perso',
		'www','email_pro','email_perso','telephone_professionnel','telephone_personnel','telephone_mobile');
} else {
	$champs=array('id_enseignant','date_in','date_modif','id_civilite','nom','prenom','epouse','id_photo',
		'id_laboratoire','id_etablissement','id_statut','id_ufr','id_grade',
		'CNU','adresse_pro','code_postal_pro','id_ville_pro','id_pays_pro',
		'www','email_pro','telephone_professionnel');
}
$filtres=array('id_enseignant' => $id);
...
$html.= '
		<table border=0>
			...
			<tr>
				...
				<th>CNU</th><td colspan="3"><input id="CNU" name="CNU" value="'.$infos[0]['CNU'].'" size="30"/></td>
			</tr>
			<tr>
