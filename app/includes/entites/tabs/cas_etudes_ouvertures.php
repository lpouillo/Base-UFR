...
$html .= '<p><table border="1" class="ouverture_ue"><tr>' .
		'<td>&nbsp;</td>';
...
foreach ($creation_tableau['Licence']['specialites'] as $specialite) {
	...
	foreach ($creation_tableau['Licence']['niveaux'] as $niveau) {
		...
		if ($mode=='rw') {
			...
			$html.= '<select name="ouv_'.$id_stage_entreprise.'_'.$niveaux[$niveau][0].'_'.$specialites[$specialite][0].'">
